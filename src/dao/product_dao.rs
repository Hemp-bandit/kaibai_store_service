...
use crate::{
    entity::product_entity::{PqProductItem, ProductEntity, ProductItem}, product::PageQueryProductData, store::PageQueryStoreBindData
};
...
pub async fn select_product_list(rb: &dyn Executor, data: &PageQueryProductData) -> Vec<ProductItem> {}
